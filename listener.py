...
def stream(queue: mp.Queue(),
    ...
    # TODO: Maybe try streaming with https://pypi.org/project/ffmpegio/ 
...
def main(device: str, src: str, bundle: torchaudio.pipelines = torchaudio.pipelines.EMFORMER_RNNT_BASE_LIBRISPEECH):
